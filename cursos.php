...
$resultado = mysqli_query($conectar,"SELECT * FROM curso ORDER BY 'data'");
    ...
    <div class="panel panel-default panel-table">
        <div class="panel-heading" >
              ...
              <p>
                	...
                	<div class="divH"><label>Cursos</label></div>
                	<div class="text-right divH">
                	<?php if ($_SESSION['usuarioNivelAcesso'] != 3) { ?>
                		 <a href="#adicionarCurso" data-toggle="modal"><button type="button" class="btn btn-info add-new"><i class="fa fa-plus" data-toggle="tooltip"></i> Adicionar novo</button></a>
                	<?php } ?>
                	</div>
			...
			<form name="form1" method="post" action="">
				...
				<?php 
					...
					while($linhas = mysqli_fetch_array($resultado)){
                        ...
                        <a href="#delete" class="delete" data-toggle="modal" data-whatever="<?php echo $linhas['nome'];?>"><i class="fa fa-trash" data-toggle="tooltip" title="Delete"></i></a>
                    	</td>
                    <?php
						echo "</tr>";
					}
...
<!-- /container -->
 ...
 <div id="adicionarCurso" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
          ...
          <br>
          <form name="adicionarCurso" method="POST" action="">
          ...
          <div class="modal-body">   
            ...
            <div class="form-group">
              ...
              <input type="text" id="curso" name="curso" autofocus="" maxlength="700" class="form-control"  required>
            </div>
          ...
          <div class="modal-footer">
            ...
            <input type="submit"  class="btn btn-info" name="adicionarCurso" value="Save">
          </div>
        </form>
      </div>
    </div>
  ...
  if(isset($_POST['adicionarCurso'] )){
	$curso = $_POST["curso"];
	
$query = mysqli_query($conectar,"INSERT INTO curso (`nome`) VALUES ('$curso')");
	if ($query) {
...
<!-- Inicio Modal Apagar -->
				...
				<div class="alert alert-danger"><span class=""></span> Tens a certeza que desejas eliminar o curso?</div>
				</div>
				<div class="modal-footer ">
...
if(isset($_POST['Eliminar'] )){
	...
	$query=mysqli_query($conectar,"DELETE FROM curso WHERE nome='$id'");
	if ($query) 
